  ...
  return <section id="contact" className="py-20 bg-baby-blue-500" ref={ref}>
      <div className="max-w-4xl mx-auto px-6">
        <div className={`text-center mb-12 transition-all duration-700 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <p className="text-white/90 font-medium text-2xl">Ready to transform your business with AI automation? Schedule a discovery call, or message us at info@bluauto.io</p>
        </div>
