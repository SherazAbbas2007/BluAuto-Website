      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-center relative z-10 w-full">
        <div className="max-w-6xl xl:max-w-7xl 2xl:max-w-none text-center w-full">
          ...
          <button 
            ...
            className="bg-white text-zinc-950 px-8 py-5 sm:px-10 sm:py-6 lg:px-12 lg:py-7 text-lg sm:text-xl lg:text-xl rounded-2xl font-semibold hover:bg-gray-100 hover:scale-110 transition-all duration-300 tracking-wide hover:shadow-[0_0_20px_rgba(255,255,255,0.6)] animate-fade-in-up" 
            style={{
              animationDelay: '0.6s',
              opacity: 0,
              animationFillMode: 'forwards'
