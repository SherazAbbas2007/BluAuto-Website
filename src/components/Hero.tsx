      ...
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between relative z-10">
        <div className="flex-1 max-w-2xl animate-fade-in-up">
          ...
          <button
            ...
            className="bg-white text-baby-blue-600 px-8 py-4 rounded-lg font-semibold hover:bg-baby-blue-50 transition-colors duration-300 uppercase tracking-wide cursor-pointer relative z-20"
        ...
        {/* Video Placeholder */}
        <div className="hidden lg:block flex-1 ml-12 animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
