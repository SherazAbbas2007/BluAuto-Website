...
const Hero = () => {
  ...
  return (
    <section className="min-h-screen bg-hero-gradient flex items-center justify-center relative overflow-hidden pt-50 sm:pt-54 md:pt-42 lg:pt-26">
      {/* Background Pattern */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-center relative z-10 w-full">
        <div className="max-w-4xl text-center">
          ...
          <button 
            ...
            className="bg-white text-zinc-950 px-8 py-5 sm:px-10 sm:py-6 lg:px-12 lg:py-7 text-lg sm:text-xl lg:text-xl rounded-2xl font-semibold hover:bg-gray-100 hover:scale-105 transition-all duration-300 tracking-wide hover:shadow-[0_0_20px_rgba(255,255,255,0.6)] animate-fade-in-up"
            style={{
              animationDelay: '0.6s',
              opacity: 0,
              animationFillMode: 'forwards'
