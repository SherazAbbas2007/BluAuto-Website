    ...
    <section className="min-h-screen bg-hero-gradient flex items-center justify-center relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-center gap-8 relative z-10 w-full">
        <div className="flex-1 max-w-2xl animate-fade-in-up text-center lg:text-left">
          <h1 className="text-6xl md:text-7xl lg:text-8xl font-bold text-white mb-7 tracking-tight leading-tight">
            Automate Your{' '}
          ...
          <button 
            ...
            className="bg-white text-zinc-950 px-11 py-6 text-xl rounded-2xl font-semibold hover:bg-gray-100 hover:scale-105 transition-all duration-300 tracking-wide hover:shadow-[0_0_20px_rgba(255,255,255,0.6)]"
          >
            Book a call
          </button>
        </div>

        {/* Video Placeholder with 16:9 aspect ratio - scaled up by 20% */}
