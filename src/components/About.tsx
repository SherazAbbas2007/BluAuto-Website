  ...
  return <section id="about" className="py-20 bg-gradient-to-b from-baby-blue-700 to-baby-blue-600" ref={ref}>
      <div className="max-w-7xl mx-auto px-10">
        ...
        <div className={`text-center mb-10 transition-all duration-700 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <h1 className="text-2xl font-bold text-white mb-3 tracking-tight md:text-5xl">Why choose us?</h1>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-stretch">
          ...
          <div className={`transition-all duration-700 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'} flex`}>
            <div className="bg-baby-blue-900/80 backdrop-blur-sm border border-baby-blue-700/50 rounded-xl p-12 flex-1 flex flex-col">
              <h2 className="text-xl font-bold text-white mb-5 tracking-tight leading-tight md:text-4xl">
                What 99% of SDRs/lead gen agencies do
              </h2>
              
              <div className="space-y-5 flex-1">
                {problems.map((problem, index) => <div key={index} className={`flex items-start space-x-3 transition-all duration-700 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{
          ...
          transitionDelay: '0.3s'
            ...
            <div className="bg-baby-blue-900/80 backdrop-blur-sm border border-baby-blue-700/50 rounded-xl p-12 flex-1 flex flex-col">
              ...
              <div className="space-y-5 flex-1">
                {solutions.map((solution, index) => <div key={index} className={`flex items-start space-x-3 transition-all duration-700 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{
